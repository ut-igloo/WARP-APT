...
var tuio = {
  ...
  _touchstart:    function(touch) {
    ...
    this._create_event('mousedown', touch, {});
  },

  _touchmove: function(touch) {
    // Create a touchmove event
    this._create_event('mousemove', touch, {});
  },

  _touchend: function(touch) {
    // Create a touchend event
    this._create_event('mouseup', touch, {});
  },

  _create_event: function(name, touch, attrs) {
    // Creates a custom DOM event
    console.log(touch, attrs);
    var evt = document.createEvent('MouseEvents');
    evt.initMouseEvent(name, true, true, window, 0, touch.pageX, touch.pageY, touch.pageX, touch.pageY, false, false, false, false, 0, null);
